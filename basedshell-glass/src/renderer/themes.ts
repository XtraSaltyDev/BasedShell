...
const defaultChrome: ThemeChrome = {
  ...
  bgSurface: '#0d0f16',
  bgElevated: '#161a28',
  bgOverlay: 'rgba(14, 17, 28, 0.95)',
  bgInset: '#11141e',
  borderDefault: 'rgba(255, 255, 255, 0.06)',
  borderSubtle: 'rgba(255, 255, 255, 0.04)',
  borderStrong: 'rgba(255, 255, 255, 0.1)',
  borderAccent: 'rgba(91, 245, 196, 0.25)',
  textPrimary: '#dfe8f8',
  textSecondary: '#97aece',
  textMuted: '#7590b8',
  textDisabled: '#566f94',
  textInverse: '#08090e',
  accent: '#5bf5c4',
  accentHover: '#8fffd9',
  accentMuted: 'rgba(91, 245, 196, 0.15)',
  accentSubtle: 'rgba(91, 245, 196, 0.07)',
  danger: '#ff6b8a',
  dangerHover: '#ff9bb0',
  dangerMuted: '#7a2a35',
  warning: '#ffd06b',
  info: '#6bacff',
  success: '#5bf5c4',
  focusRing: 'rgba(91, 245, 196, 0.4)',
  topbarBg: 'rgba(14, 17, 28, 0.55)',
  statusbarBg: 'rgba(14, 17, 28, 0.55)',
  statusbarFg: '#566f94',
  panelBg: 'rgba(14, 17, 28, 0.72)',
  panelBorder: 'rgba(255, 255, 255, 0.1)',
  searchBg: 'rgba(14, 17, 28, 0.72)',
  searchBorder: 'rgba(255, 255, 255, 0.1)',
  inputBg: 'rgba(0, 0, 0, 0.3)',
  inputBorder: 'rgba(255, 255, 255, 0.1)',
  inputFg: '#ffffff',
  inputPlaceholder: '#3f4f6e',
  tabBgIdle: 'transparent',
  tabBgActive: 'rgba(14, 17, 28, 0.72)',
  tabBgHover: 'rgba(255, 255, 255, 0.04)',
  tabFgIdle: '#7590b8',
  tabFgActive: '#ffffff',
  tabBorderIdle: 'transparent',
  tabBorderActive: 'rgba(255, 255, 255, 0.1)',
  tabIndicator: '#5bf5c4'
};
